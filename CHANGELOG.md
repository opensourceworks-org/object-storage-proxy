...
### Documentation
- Update CHANGELOG for v0.6.11 [skip ci]
...
### Documentation
- Update CHANGELOG for v0.6.10 [skip ci]
...
### Documentation
- Update CHANGELOG for v0.6.9 [skip ci]


### Fixed
- Update sign requests for http/pingora
...
- Update CHANGELOG for v0.6.8 [skip ci]
